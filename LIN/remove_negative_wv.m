...
p_era_wv.co2ppm=co2_vs_time(tai2dtime(p_era_wv.ptime));


file_out=[loc,'_AIRS_wv_lls.rtp']; 
file_era_out=[loc,'_era_AIRS_wv_lls.rtp']; 
%file_unc_out=[loc,'_AIRS_uncert_wv_lls.rtp']
